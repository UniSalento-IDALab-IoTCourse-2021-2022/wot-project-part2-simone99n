...
function measureGenerator(data_raw, anomaly) {
    ...
    if (anomaly===0){
        ...
        grip_strength_tosend = getNormallyDistributedRandomNumber(grip_strength - grip_strength/80, 0.01).toFixed(4)
        muscle_mass_tosend = getNormallyDistributedRandomNumber(muscle_mass - muscle_mass/80, 0.01).toFixed(4)
    }
    else if (anomaly===2){
